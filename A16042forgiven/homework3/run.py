...
@app.route('/details/<string:student_number>/music')
def music(student_number):
	data = read_json_file('static/data/index.json')
	user_data = {}
	for item in data:
		if student_number == item['student_number']:
 			user_data = item
			break
	return render_template('music.html', data=user_data)
...
@app.route('/details/<string:student_number>/contact')
def music(student_number):
	data = read_json_file('static/data/index.json')
	user_data = {}
	for item in data:
		if student_number == item['student_number']:
			user_data = item
			break
	return render_template('contact.html', data=user_data)
